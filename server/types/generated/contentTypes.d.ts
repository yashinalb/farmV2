...
export interface ApiBuyerTypeBuyerType extends Schema.CollectionType {
  collectionName: 'buyer_types';
  info: {
    singularName: 'buyer-type';
    pluralName: 'buyer-types';
    displayName: 'BuyerType';
    description: '';
  };
  options: {
  ...
  attributes: {
    name: Attribute.String;
    buyers_infos: Attribute.Relation<
      'api::buyer-type.buyer-type',
      'oneToMany',
      'api::buyers-info.buyers-info'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiBuyersInfoBuyersInfo extends Schema.CollectionType {
  ...
  attributes: {
    ...
    kdv: Attribute.Integer;
    stopaj: Attribute.Integer;
    komisyon: Attribute.Integer;
...
export interface ApiInvoiceInvoice extends Schema.CollectionType {
  ...
  attributes: {
    ...
    buyers_info: Attribute.Relation<
      'api::invoice.invoice',
      'manyToOne',
      'api::buyers-info.buyers-info'
    >;
    ...
    >;
    payments_tables: Attribute.Relation<
      'api::invoice.invoice',
      'oneToMany',
...
export interface ApiInvoiceDetailInvoiceDetail extends Schema.CollectionType {
  ...
  attributes: {
    ...
    invoice: Attribute.Relation<
      ...
      'api::invoice.invoice'
    >;
    product_quantity_type: Attribute.Relation<
      'api::invoice-detail.invoice-detail',
      'oneToOne',
      'api::product-quantity-type.product-quantity-type'
    >;
...
export interface ApiPaymentsTablePaymentsTable extends Schema.CollectionType {
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    invoice_details: Attribute.Relation<
      ...
      'api::invoice-detail.invoice-detail'
    >;
    product_quantity_types: Attribute.Relation<
      'api::product.product',
      'oneToMany',
      'api::product-quantity-type.product-quantity-type'
    >;
...
export interface ApiProductQuantityTypeProductQuantityType
  extends Schema.CollectionType {
  collectionName: 'product_quantity_types';
  info: {
    singularName: 'product-quantity-type';
    pluralName: 'product-quantity-types';
    displayName: 'ProductQuantityType';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::buyer-type.buyer-type': ApiBuyerTypeBuyerType;
      'api::buyers-info.buyers-info': ApiBuyersInfoBuyersInfo;
      ...
      'api::payments-table.payments-table': ApiPaymentsTablePaymentsTable;
      'api::product.product': ApiProductProduct;
      'api::product-category.product-category': ApiProductCategoryProductCategory;
      'api::product-quantity-type.product-quantity-type': ApiProductQuantityTypeProductQuantityType;
    }
  }
}
